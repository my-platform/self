...
if (!@mysql_select_db('dashboard')) {
    ...
    function pagination($table, $index, $page_id){
        ...
        $sql1 = "SELECT COUNT(`firstname`) FROM `" . $table . "` WHERE `trash` =1";
    ...
    function table($table, $page_id)
    {
        ...
        $sql = "SELECT * FROM `" . $table . "` WHERE `trash` =1  ORDER BY `trash_date` ASC LIMIT $start, $limit";
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked mail-links">
                            ...
                            <li id="trash-link" class="active"><a id="mail-trash" href="mail-trash.php"><i class="fa fa-trash-o"></i> Trash</a></li>
                        </ul>
                    </div>
                    <!-- /.box-body -->
                </div>
                    ...
                    <div class="box-body no-padding">
                        ...
                        <div class="mailbox-controls toggle-div">
                            ...
                            <div class="row">
                                ...
                                <div class="btn-group col-md-11 col-sm-6">
                                    ...
                                    <button type="button" data-toggle="modal" data-target="#popUpWindow2" class="btn btn-default btn-sm delete-to-trash"><i class="fa fa-trash-o"></i>
                                    </button>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div role="form">
                                            ...
                                            <div class="form-group">
                                                <b>The selected message/messages is gonna be deleted fully, you wanna keep going?</b>
                                            </div>
                                            <div class="form-group">
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button  id="delete-from-trash" class="btn btn-primary btn-md" data-dismiss="modal">Yes</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive mailbox-messages mailbox-msg">
                            <table class="table table-hover table-striped">
                                <tbody>
                                <!-- <tr>
                                      <td><input type="checkbox" class="msgs-check"></td>
